...
import static de.maddin.multitime.utils.StringUtils.getTimeLockedMessage;
...
public class CommandGet implements Command {
    ...
    public boolean run(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        affectedWorlds.forEach(world -> sender.sendMessage(getMessage("time_get_success",
    ...
    public String getHelp() {
        return getMessage("time_get_help", COMMAND);
    }
}
